    ...
    <div className="md:flex flex-row w-full h-auto py-10 md:py-0">
      ...
      >
        <p className="text-[12px] text-white md:p-5 text-justify">
          ...
          landscape. Saudi Arabia stands at a pivotal point in its
          ...
          knowledge-driven future. This dynamic evolution is compelling public
          ...
          core enablers of digital maturity and enterprise innovation. As
          ...
          reinforcing the national push toward a smarter, more agile economy.
